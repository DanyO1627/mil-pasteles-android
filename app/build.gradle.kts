...
dependencies {
    ...
    // para que esta se cargue, primero hay que comentarla, luego sync y después soltarla y sincronizar con ella
    // pero antes, hay que ir a los plugin de este mismo archivo y poner id() y porner lo que está en el otro (esto: id("com.google.devtools.ksp"))
